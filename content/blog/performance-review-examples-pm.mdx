...
<ImagePlaceholder
  ...
  caption="Flow diagram idea: self-review → manager's packet → calibration room → rating. Most PMs write for the first step; the document lives or dies at the third."
/>
...
<ImagePlaceholder
  ...
  caption="Side-by-side card idea: identical quarter written in activity language (left) vs outcome language (right), with the numbers and tradeoffs visually highlighted on the right."
/>
...
<ImagePlaceholder
  label="From running log to review line"
  caption="Illustration idea: a quarter's timeline of small logged entries condensing (arrow / funnel) into one polished self-review bullet — many small notes in, one strong numbered line out."
/>
