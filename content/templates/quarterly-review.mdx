...
<ImagePlaceholder
  src="/images/templates/quarterly-review-template-preview.png"
  alt="Preview of the PM performance review template showing the four-section self-review structure with a worked example"
