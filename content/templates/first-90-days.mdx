...
<ImagePlaceholder
  src="/images/templates/first-90-days-template-preview.png"
  alt="Preview of the first 90 days template showing the three-phase structure with stakeholder map and early wins log"
