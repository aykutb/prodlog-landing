...
<ImagePlaceholder
  src="/images/templates/star-story-bank-template-preview.png"
  alt="Preview of the STAR story bank template showing the category map with ten behavioral question categories and story coverage tracking"
