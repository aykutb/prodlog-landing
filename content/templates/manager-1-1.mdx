...
<ImagePlaceholder
  src="/images/templates/manager-1-1-template-preview.png"
  alt="Preview of the PM manager 1:1 template showing weekly sections for shipped work, decisions, blockers, and visibility"
