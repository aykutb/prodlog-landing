...
<ImagePlaceholder
  src="/images/pillars/brag-document-sample-log.png"
  alt="Prodlog sample log page showing a quarterly timeline of impact entries with dates, status, verified badges, metrics, and collaborators"
  label="Hero: PM brag document overview"
  caption="A living brag document: quarterly impact entries with the initiative, your role, the metric that moved, and collaborators who can confirm it."
/>
...
<ImagePlaceholder
  src="/images/pillars/brag-document-before-after.png"
  alt="Split panel: scattered Slack threads, PRD documents, and tickets on the left versus a single structured Prodlog logging screen with writing prompts on the right"
  label="Why PMs need a brag document"
  caption="Before and after: the same week of PM work as scattered Slack threads, PRDs, and tickets — versus one structured, prompted log entry."
/>
...
<ImagePlaceholder
  src="/images/pillars/brag-document-entry-fields.png"
  alt="Prodlog entry enrichment screen showing the fields of a brag document entry: date, metrics, tags, teammates involved, and attribution confidence"
  label="Anatomy of a strong brag document entry"
  caption="The fields behind a strong entry: date, metrics, tags, and the teammates who can confirm the work — captured in the moment, not reconstructed."
/>
...
<ImagePlaceholder
  src="/images/templates/brag-document-template-preview.png"
  alt="Preview of the downloadable PM brag document template showing quarterly headings, prompt questions, and a filled example entry"
  label="Free brag document template preview"
  caption="The downloadable template: quarterly headings, prompt questions for every field, and filled example entries."
/>
