...
<ImagePlaceholder
  ...
  caption="Suggested visual: a polished public portfolio page (e.g. Prodlog @username view) with an about section at top, 2–3 case study cards below, and a verified badge on one entry — gives readers an instant picture of what a finished PM portfolio looks like."
/>
...
<ImagePlaceholder
  ...
  caption="Suggested visual: diagram or stacked layers showing how the five pieces connect — impact log at the base (private, ongoing), case studies and resume bullets in the middle (distilled outputs), career narrative as a header frame, and verifiable proof as a trust layer on top. Arrows showing log → case study → public portfolio flow."
/>
...
<ImagePlaceholder
  ...
  caption="Suggested visual: side-by-side comparison of two entries — left: vague bullet ('Led mobile redesign, improved UX'); right: specific entry with decision rationale, metric, and a verified collaborator badge. Annotate what interviewers discount vs. what they remember."
/>
...
<ImagePlaceholder
  label="Portfolio build flow: log first, format last"
  caption="Suggested visual: simple funnel or pipeline — raw impact log entries (many, private) narrowing into 5–8 shortlisted entries, then 2–3 expanded case studies, then a single shareable portfolio link at the end. Emphasizes that design/format is the last step, not the first."
/>
...
<ImagePlaceholder
  ...
  caption="Suggested visual: four-column or 2×2 grid comparing format types — personal website, Notion/Google Doc, LinkedIn Featured, dedicated tool — with icons for effort to build, effort to maintain, and signal strength. Keep it honest: Notion = low effort / good signal; LinkedIn Featured = low effort / low signal; custom site = high effort / variable signal."
/>
...
<ImagePlaceholder
  label="From ongoing log to shareable portfolio"
  caption="Suggested visual: timeline showing consistent monthly log entries over 12 months on the left, branching into multiple outputs on the right — case study, resume bullet, interview prep note, and public @username page. Optional contrast inset: a stale portfolio with one burst of entries right before a job search."
/>
...
<div className="not-prose border-t border-divider pt-12 mt-12 text-center">
  <p className="text-secondary text-base leading-relaxed mb-6 max-w-xl mx-auto">
  ...
  <p className="mt-4 text-sm">
    <a href="/pricing" className="text-deep-ink-blue underline hover:opacity-80">
