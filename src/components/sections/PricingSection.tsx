    ...
    <div className="max-w-4xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
        <div className="p-8 border border-divider rounded bg-ink flex flex-col">
          ...
          <button className="w-full py-2 border border-divider rounded text-primary text-sm hover:bg-charcoal transition-colors">
            Start Free
          </button>
        </div>
        <div className="p-8 border border-impact rounded bg-ink flex flex-col relative overflow-hidden">
          ...
          <button className="w-full py-2 bg-impact text-white rounded text-sm hover:opacity-90 transition-colors">
            Get Pro
          </button>
        </div>
      </div>
