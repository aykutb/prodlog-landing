...
// Inline SVGs matching the lucide icons (and custom brand icons) the
// dashboard's bento cards use, so the public page renders identically
// without adding an icon dependency.

type IconProps = { className?: string };

const lucide = (props: IconProps, children: React.ReactNode) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
